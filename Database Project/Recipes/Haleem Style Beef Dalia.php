...
$recipe_id = 14; // Use the correct recipe ID
...
<html lang="en" dir="ltr">
    ...
    const recipeId = 14; // Correct recipe ID
    ...
    if (isRed) {
        ...
        <?php
        $sql = "SELECT description FROM recipes WHERE recipe_id = 14";
            $result = $conn->query($sql);
            if ($result && $result->num_rows > 0) {
                // Output data
            ...
            $sql = "SELECT name, measurement FROM ingredient WHERE recipe_id = 14";
            $result = $conn->query($sql);
            ...
            $sql = "SELECT instructions FROM recipes WHERE recipe_id = 14";
            $result = $conn->query($sql);

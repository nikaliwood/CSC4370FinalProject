...
<html lang="en" dir="ltr">
    <head>  
        ...
        <link rel = "stylesheet" href="recipess.css">
    ...
    <?php
        ...
        if ($result && $result->num_rows > 0) {
            ...
            echo "<img src='./Recipes/$imagePath' alt='$title' style='width: 100%'>";
            echo "</div>";
        }
        $sql = "SELECT description FROM recipes WHERE recipe_id = 1";
            ...
            echo "<center><h4>Ingredients</h4><br></center>";
        ...
        echo "<center><br><h4>Instructions<br></h4></center>";
        echo "<br><br>";
        ...
        while ($valid = $result->fetch_assoc()) {
            // Output the instructions as list items
            echo "<div class='instructions'>{$valid['instructions']}</div>";    }
